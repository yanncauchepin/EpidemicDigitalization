all_place_typages = [
    ...
    ("accomodation", "hotel"), ("accomodation", "housing"),
    ("accomodation", "pension"), ("accomodation", "prison"),
    
    ("education", "school"), ("education", "academic"),
    ("education", "others"),
    
    ("command", "law"), ("command", "politics"),
    ("command", "police"),
    
    ("office", "office"),
    
    ("commerce", "supermarket"), ("commerce", "nocturnal"),
    ("commerce", "shop"), ("commerce", "mall"),
    ("commerce","limited_restoration"), ("commerce", "out_restoration"),
    
    ("commerce", "leisure_inside"), ("commerce", "leisure_outside"), 
    ("commerce", "art"), ("commerce", "sport_inside"),
    ("commerce", "sport_outside"),
    
    ("social", "funeral"), ("social", "inside"), 
    ("social", "park"), ("social", "religious"), 
    ("social","kindergarten"),
    
    ("production", "craft"), ("production", "industry"), 
    ("production", "agriculture"), ("production", "construction"),
    
    ("health", "pharmacy"), ("health", "clinic"), 
    ("health", "hospital"), ("health", "doctor"), 
    ("health", "others"),
    
    ("logistic", "post"), ("logistic", "garage"), 
    ("logistic", "common_transport"), ("logistic", "airport"), 
    ("logistic", "fuel")
...
def get_typage_place_from_osm_tags(osm_tags) :
    ...
    if (osm_tags.get("highway")) not in (None, "construction") :
        return ("data_road", "road")

    #Type : accomodation
    elif (osm_tags.get("building") == "hotel") \
